...
;(function () {
  ...
  evt.characterData = () => ({
    ...
    animations: [
      ...
      {
        name: 'meteor',
        cancellable: 'airupspecial.airjumpN.airjump1.airjump2',
        cancel: 'fall',
        starKO: true,
        techable: true,
        noFastfall: true,
        ...
        keyframes: [
          ...
          },
          {
            ...
            start: function (entity, controller) {
              ...
              entity.pseudojumps++
              entity.dy = entity.dy + diff * (1 - Math.pow(1 - 1 / entity.pseudojumps, 2))
            ...
            hitbubbles: [
              {
                ...
                onHit: (hb) => {
                  hb.entity.dy += 10
                  hb.entity.dx -= hb.entity.face * 4
                  hb.entity.schedule('airdownspecial2', true)
                },
                onBlocked: (hb) => {
                  hb.entity.dy += 10
                  hb.entity.dx -= hb.entity.face * 4
        ...
        keyframes: [
          ...
          },
          {
            ...
            handler: function (entity, controller) {
              entity.hurtbubbles[0].x = controller.hmove * 40
              entity.hurtbubbles[0].y = controller.vmove * 40 - 10
            }
          },
          {
            duration: 4,
            ...
            start: function (entity, controller, animation) {
              if (animation.bubble === null) {
                animation.bubble = Hitbubble.from(entity, {
                  type: 'special',
                  radius: 20,
                  damage: 7,
                  knockback: 5,
              ...
              animation.bubble.x = controller.hmove * 45 * entity.face
              animation.bubble.y = controller.vmove * -45 + 10
            },
            handler: function (entity, controller, animation) {
              entity.hurtbubbles[0].x = animation.bubble.x * entity.face
              entity.hurtbubbles[0].y = -animation.bubble.y
              entity.addHitbubble(animation.bubble)
            }
          },
          {
            duration: 16,
            ...
            handler: function (entity, controller, animation) {
              entity.hurtbubbles[0].x = entity.face * -(entity.hurtbubbles[0].x + (entity.hurtbubbles[0].x - animation.bubble.x) * (1 - animation.midframe / this.duration))
              entity.hurtbubbles[0].y = -(entity.hurtbubbles[0].y + (entity.hurtbubbles[0].y - -animation.bubble.y) * (1 - animation.midframe / this.duration)) - 10
            }
          },
          {
            duration: 40,
      ...
      },
      {
        ...
        start: function (entity) {
          ...
          if (entity.airjumps >= entity.animations['airjumpN'].jumps) {
        ...
        keyframes: [
          ...
          },
          {
            ...
            start: function (entity, controller) {
              ...
              entity.dy = j.upward - (j.jumpDecay ? j.jumpDecay * entity.airjumps : 0)
              ...
              entity.dx = entity.dx + entity.face * 6
            },
            hurtbubbles: [
              17, 17, 4, 1,
              -17, 17, 7, 1,
      ...
      },
      {
        ...
        handler: (entity, controller) => {
          if (entity.airjumps < entity.animations['airjumpN'].jumps && (controller.jumpPress || controller.specialPress)) {
            entity.airjumps++
      ...
      },
      {
        ...
        handler: function (entity, controller) {
          if (this.frame > 12 && controller.attackPress) {
